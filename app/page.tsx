...
const sd = [
  ...
  {"@context":"https://schema.org","@type":"Organization","name":"APScore5","url":"https://apscore5.com","logo":"https://apscore5.com/images/apscore5-logo.svg","sameAs":["https://www.youtube.com/@APScore5","https://www.tiktok.com/@apscore5"]},
      ...
      <div className="nav-wrap">
        <nav className="container nav">
          <a href="/" aria-label="APScore5 Home">
            ...
            <img src="/images/apscore5-logo.svg" alt="APScore5 logo" className="brand-logo"/>
          </a>
      ...
      <footer>
        <div className="container">
          <div className="footer-inner">
            <div>
              {/* eslint-disable-next-line @next/next/no-img-element */}
              <img src="/images/apscore5-logo.svg" alt="APScore5" className="footer-logo"/>
