...
export const metadata = {
  ...
  openGraph: {
    title: "AP Test Practice — Free AP Exam Prep | APScore5",
    description: "Free AP practice questions for AP Biology, AP Human Geography, and AP CSP. Study 5 minutes a day and score a 5 on your AP test.",
...
const faqs = [
  ...
  {q:"How long is an AP test?",a:"Most AP exams run between 2 and 3.5 hours. AP Biology is about 3 hours, AP Human Geography is around 2 hours 15 minutes, and AP CSP is about 2 hours. Always check the College Board official schedule."},
  ...
  {q:"Do AP test scores matter for college?",a:"Yes. Strong AP scores (3-5) can earn college credit or placement out of introductory courses, saving tuition and time. Taking AP courses also signals academic rigor to admissions offices."},
...
export default async function Home() {
  let meta = {meta_title:"",meta_description:"",og_image:null};
  try { const c = createClient(); const p = await c.getSingle("homepage"); meta = {meta_title:p.data.meta_title||"",meta_description:p.data.meta_description||"",og_image:p.data.og_image?.url?{url:p.data.og_image.url}:null}; } catch {}
  return (
    <>
      {sd.map((s,i)=><script key={i} type="application/ld+json" dangerouslySetInnerHTML={{__html:JSON.stringify(s)}}/>)}
      <div className="nav-wrap">
        <nav className="container nav">
          <a href="/" aria-label="APScore5 Home"><img src="/images/apscore5-logo.png" alt="APScore5 logo" className="brand-logo"/></a>
        ...
        <div className="container">
          <div className="hero-inner">
            ...
            <div className="qcard" role="region" aria-label="Sample AP practice question">
              ...
              <div className="prog" role="progressbar" aria-valuenow={30} aria-valuemin={0} aria-valuemax={100}><div className="progb" style={{width:"30%"}}></div></div>
              ...
              <div className="opts" id="hero-opts">
                <div className="opt" data-correct="false" tabIndex={0} role="button"><span className="letter">A</span><span>Nucleus</span></div>
                <div className="opt" data-correct="true" tabIndex={0} role="button"><span className="letter">B</span><span>Mitochondria</span></div>
                <div className="opt" data-correct="false" tabIndex={0} role="button"><span className="letter">C</span><span>Ribosome</span></div>
                <div className="opt" data-correct="false" tabIndex={0} role="button"><span className="letter">D</span><span>Golgi Apparatus</span></div>
              </div>
              <div className="feedback" id="hero-feedback"><strong>✓ Correct — Mitochondria</strong>Mitochondria are the powerhouse of the cell, converting glucose into ATP via cellular respiration. This is a high-frequency AP Bio topic.</div>
      ...
      <section aria-labelledby="courses-heading">
        <div className="container">
          ...
          <h2 id="courses-heading">Choose your AP course and start today.</h2>
      ...
      <section aria-labelledby="nl-heading">
        <div className="container">
          <div className="nl-box">
            <div><h3 id="nl-heading">Get a free AP question every day.</h3><p>One question. One clear explanation. Daily practice that compounds over time.</p></div>
            <div>
        ...
        <div className="container">
          <div className="cta-box">
            <div>
              ...
              <h2 id="cta-heading">Give it 5 minutes a day.<br/>Let the progress compound.</h2>
      ...
      <footer>
        <div className="container">
          <div className="footer-inner">
            <div>
              <img src="/images/apscore5-logo.png" alt="APScore5" className="footer-logo"/>
...
(function(){
  ...
  document.querySelectorAll('#hero-opts .opt').forEach(function(o){
    o.addEventListener('click',function(){
      ...
      document.querySelectorAll('#hero-opts .opt').forEach(function(x){x.style.pointerEvents='none';if(x.getAttribute('data-correct')==='true')x.classList.add('show-correct');});
      o.classList.add(ok?'chosen-correct':'chosen-wrong');
      document.getElementById('hero-feedback').classList.add('show');
