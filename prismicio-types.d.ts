...
interface CourseDocumentData {
  ...
  /**
   * Course Description field in *Course*
   *
  ...
  /**
   * Icon (emoji) field in *Course*
   *
   * - **Field Type**: Text
   * - **Placeholder**: 🧬
   * - **API ID Path**: course.icon
   * - **Tab**: Main
   * - **Documentation**: https://prismic.io/docs/fields/text
   */
  ...
  /**
   * Question Count (display string) field in *Course*
   *
   * - **Field Type**: Text
   * - **Placeholder**: 4,800 questions
   * - **API ID Path**: course.question_count
   * - **Tab**: Main
   * - **Documentation**: https://prismic.io/docs/fields/text
   */
  question_count: prismic.KeyTextField;

  /**
   * URL Path field in *Course*
   *
   * - **Field Type**: Text
   * - **Placeholder**: /ap-biology
   * - **API ID Path**: course.url_path
   * - **Tab**: Main
   * - **Documentation**: https://prismic.io/docs/fields/text
   */
  url_path: prismic.KeyTextField;

  /**
   * Sort Order (lower = first) field in *Course*
   *
   * - **Field Type**: Number
   * - **Placeholder**: 1
   * - **API ID Path**: course.order
   * - **Tab**: Main
...
interface CoursePillarPageDocumentData {
   ...
   * - **Field Type**: Image
   * - **Placeholder**: *None*
   * - **API ID Path**: course_pillar_page.banner_image
   * - **Tab**: Main
   ...
   * - **Field Type**: Date
   * - **Placeholder**: *None*
   * - **API ID Path**: course_pillar_page.last_reviewed
   * - **Tab**: SEO
...
interface FaqBlockDocumentData {
   ...
   *
   * - **Field Type**: Text
   * - **Placeholder**: How are AP tests scored?
   * - **API ID Path**: faq_block.question
   * - **Tab**: Main
   * - **Documentation**: https://prismic.io/docs/fields/text
   */
  ...
  /**
   * Sort Order (lower = first) field in *FAQ Item*
   *
   * - **Field Type**: Number
   * - **Placeholder**: 1
   * - **API ID Path**: faq_block.order
   * - **Tab**: Main
   * - **Documentation**: https://prismic.io/docs/fields/number
   */
  order: prismic.NumberField;
...
/**
 * Item in *Homepage → Trust Items*
 */
export interface HomepageDocumentDataTrustItemsItem {
  /**
   * Value field in *Homepage → Trust Items*
   *
   * - **Field Type**: Text
   * - **Placeholder**: 12,000+
   * - **API ID Path**: homepage.trust_items[].value
   * - **Documentation**: https://prismic.io/docs/fields/text
   */
  value: prismic.KeyTextField;

  /**
   * Label field in *Homepage → Trust Items*
   *
   * - **Field Type**: Text
   * - **Placeholder**: AP Practice Questions
   * - **API ID Path**: homepage.trust_items[].label
   * - **Documentation**: https://prismic.io/docs/fields/text
   */
...
/**
 * Item in *Homepage → Stats Bar Items*
 */
export interface HomepageDocumentDataStatsItem {
  /**
   * Value field in *Homepage → Stats Bar Items*
   *
   * - **Field Type**: Text
   * - **Placeholder**: 12,000+
   * - **API ID Path**: homepage.stats[].value
   * - **Documentation**: https://prismic.io/docs/fields/text
   */
  value: prismic.KeyTextField;

  /**
   * Label field in *Homepage → Stats Bar Items*
   *
   * - **Field Type**: Text
   * - **Placeholder**: AP Practice Questions
   * - **API ID Path**: homepage.stats[].label
   * - **Documentation**: https://prismic.io/docs/fields/text
   */
  label: prismic.KeyTextField;
}
...
/**
 * Item in *Homepage → CTA Points*
 */
export interface HomepageDocumentDataCtaPointsItem {
  /**
   * Point Text field in *Homepage → CTA Points*
   *
   * - **Field Type**: Text
   * - **Placeholder**: ✓ Start before signup friction appears
   * - **API ID Path**: homepage.cta_points[].text
   * - **Documentation**: https://prismic.io/docs/fields/text
   */
...
interface HomepageDocumentData {
   ...
   *
   * - **Field Type**: Text
   * - **Placeholder**: AP Test Practice — Free AP Exam Prep | APScore5
   ...
   *
   * - **Field Type**: Text
   * - **Placeholder**: Free AP practice questions for AP Biology, AP Human Geography, and AP CSP.
   ...
   */
  og_image: prismic.ImageField<never>; /**
   * Eyebrow field in *Homepage*
   *
   * - **Field Type**: Text
   * - **Placeholder**: Free AP Exam Prep — No Signup Required
   * - **API ID Path**: homepage.hero_eyebrow
   * - **Tab**: Hero
   * - **Documentation**: https://prismic.io/docs/fields/text
   */
   ...
   * - **Documentation**: https://prismic.io/docs/fields/rich-text
   */
  hero_headline: prismic.RichTextField;

  /**
   * Subheadline field in *Homepage*
   *
   * - **Field Type**: Rich Text
   * - **Placeholder**: *None*
   * - **API ID Path**: homepage.hero_subheadline
   * - **Tab**: Hero
   * - **Documentation**: https://prismic.io/docs/fields/rich-text
   */
  hero_subheadline: prismic.RichTextField;

  /**
   * Primary CTA Text field in *Homepage*
   *
   * - **Field Type**: Text
   * - **Placeholder**: Create a free account
   * - **API ID Path**: homepage.hero_cta_primary_text
   * - **Tab**: Hero
   * - **Documentation**: https://prismic.io/docs/fields/text
   */
  hero_cta_primary_text: prismic.KeyTextField;

  /**
   * Primary CTA URL field in *Homepage*
   *
   * - **Field Type**: Link
   * - **Placeholder**: *None*
   * - **API ID Path**: homepage.hero_cta_primary_url
   * - **Tab**: Hero
   * - **Documentation**: https://prismic.io/docs/fields/link
   */
  hero_cta_primary_url: prismic.LinkField<
    string,
    string,
    unknown,
    prismic.FieldState,
  ...
  /**
   * Secondary CTA Text field in *Homepage*
   *
   * - **Field Type**: Text
   * - **Placeholder**: Browse AP Courses
   * - **API ID Path**: homepage.hero_cta_secondary_text
   * - **Tab**: Hero
   * - **Documentation**: https://prismic.io/docs/fields/text
   */
  hero_cta_secondary_text: prismic.KeyTextField;

  /**
   * Secondary CTA URL field in *Homepage*
   *
   * - **Field Type**: Link
   * - **Placeholder**: *None*
   * - **API ID Path**: homepage.hero_cta_secondary_url
   * - **Tab**: Hero
   * - **Documentation**: https://prismic.io/docs/fields/link
   */
  hero_cta_secondary_url: prismic.LinkField<
    string,
    string,
    unknown,
    prismic.FieldState,
  ...
  /**
   * Hero Note field in *Homepage*
   *
   * - **Field Type**: Text
   * - **Placeholder**: ✓ Free forever · ✓ No credit card · ✓ Start in 30 seconds
   * - **API ID Path**: homepage.hero_note
   * - **Tab**: Hero
   * - **Documentation**: https://prismic.io/docs/fields/text
   */
  hero_note: prismic.KeyTextField;

  /**
   * Trust Items field in *Homepage*
   *
   * - **Field Type**: Group
   * - **Placeholder**: *None*
   * - **API ID Path**: homepage.trust_items[]
   * - **Tab**: Hero
   * - **Documentation**: https://prismic.io/docs/fields/repeatable-group
   */
  trust_items: prismic.GroupField<
    Simplify<HomepageDocumentDataTrustItemsItem>
  >; /**
   * Stats Bar Items field in *Homepage*
   *
   * - **Field Type**: Group
   * - **Placeholder**: *None*
   ...
   * Courses Kicker field in *Homepage*
   *
   * - **Field Type**: Text
   * - **Placeholder**: AP Courses
   * - **API ID Path**: homepage.courses_kicker
   * - **Tab**: Courses Section
   * - **Documentation**: https://prismic.io/docs/fields/text
   */
  courses_kicker: prismic.KeyTextField;

  /**
   * Courses Headline field in *Homepage*
   *
   * - **Field Type**: Text
   * - **Placeholder**: Choose your AP course and start today.
   * - **API ID Path**: homepage.courses_headline
   * - **Tab**: Courses Section
   * - **Documentation**: https://prismic.io/docs/fields/text
   */
  courses_headline: prismic.KeyTextField;

  /**
   * Courses Description field in *Homepage*
   *
   * - **Field Type**: Text
   * - **Placeholder**: Each course is broken into unit pages, quizzes, and study guides.
   * - **API ID Path**: homepage.courses_description
   * - **Tab**: Courses Section
   * - **Documentation**: https://prismic.io/docs/fields/text
   */
  courses_description: prismic.KeyTextField; /**
   * CTA Kicker field in *Homepage*
   *
   * - **Field Type**: Text
   * - **Placeholder**: Start Free
   * - **API ID Path**: homepage.cta_kicker
   * - **Tab**: CTA Section
   * - **Documentation**: https://prismic.io/docs/fields/text
   */
  cta_kicker: prismic.KeyTextField;

  /**
   * CTA Headline field in *Homepage*
   *
   * - **Field Type**: Rich Text
   * - **Placeholder**: *None*
   * - **API ID Path**: homepage.cta_headline
   * - **Tab**: CTA Section
   * - **Documentation**: https://prismic.io/docs/fields/rich-text
   */
  cta_headline: prismic.RichTextField;

  /**
   * CTA Body field in *Homepage*
   *
   * - **Field Type**: Rich Text
   * - **Placeholder**: *None*
   * - **API ID Path**: homepage.cta_body
   * - **Tab**: CTA Section
   * - **Documentation**: https://prismic.io/docs/fields/rich-text
   */
  ...
  /**
   * CTA Points field in *Homepage*
   *
   * - **Field Type**: Group
   * - **Placeholder**: *None*
   * - **API ID Path**: homepage.cta_points[]
   * - **Tab**: CTA Section
   * - **Documentation**: https://prismic.io/docs/fields/repeatable-group
   */
  cta_points: prismic.GroupField<Simplify<HomepageDocumentDataCtaPointsItem>>;

  /**
   * CTA Primary Text field in *Homepage*
   *
   * - **Field Type**: Text
   * - **Placeholder**: Try a free question →
   * - **API ID Path**: homepage.cta_primary_text
   * - **Tab**: CTA Section
   * - **Documentation**: https://prismic.io/docs/fields/text
   */
  ...
  /**
   * CTA Primary URL field in *Homepage*
   *
   * - **Field Type**: Link
   * - **Placeholder**: *None*
   * - **API ID Path**: homepage.cta_primary_url
   * - **Tab**: CTA Section
   * - **Documentation**: https://prismic.io/docs/fields/link
   */
  cta_primary_url: prismic.LinkField<
    string,
    string,
    unknown,
    prismic.FieldState,
  ...
  /**
   * CTA Secondary Text field in *Homepage*
   *
   * - **Field Type**: Text
   * - **Placeholder**: Read AP exam FAQ
   * - **API ID Path**: homepage.cta_secondary_text
   * - **Tab**: CTA Section
   * - **Documentation**: https://prismic.io/docs/fields/text
   */
  ...
  /**
   * CTA Secondary URL field in *Homepage*
   *
   * - **Field Type**: Link
   * - **Placeholder**: *None*
   * - **API ID Path**: homepage.cta_secondary_url
   * - **Tab**: CTA Section
   * - **Documentation**: https://prismic.io/docs/fields/link
   */
  cta_secondary_url: prismic.LinkField<
    string,
    string,
    unknown,
    prismic.FieldState,
   ...
   *
   * - **Field Type**: Text
   * - **Placeholder**: Get a free AP question every day.
  ...
  /**
   * Newsletter Body field in *Homepage*
   *
   * - **Field Type**: Text
   * - **Placeholder**: One question. One clear explanation. Daily practice that compounds over time.
   * - **API ID Path**: homepage.newsletter_body
   * - **Tab**: Newsletter
   * - **Documentation**: https://prismic.io/docs/fields/text
   */
  newsletter_body: prismic.KeyTextField;
}
...
export interface NavigationDocumentDataNavLinksItem {
  ...
  /**
   * URL field in *Navigation → Nav Links*
   *
   * - **Field Type**: Text
   * - **Placeholder**: /courses
   * - **API ID Path**: navigation.nav_links[].url
   * - **Documentation**: https://prismic.io/docs/fields/text
   */
...
/**
 * Item in *Navigation → Footer — AP Courses*
 */
export interface NavigationDocumentDataFooterCoursesItem {
  /**
   * Label field in *Navigation → Footer — AP Courses*
   *
   * - **Field Type**: Text
   * - **Placeholder**: AP Biology
   * - **API ID Path**: navigation.footer_courses[].label
   * - **Documentation**: https://prismic.io/docs/fields/text
   */
  label: prismic.KeyTextField;

  /**
   * URL field in *Navigation → Footer — AP Courses*
   *
   * - **Field Type**: Text
   * - **Placeholder**: /ap-biology
   * - **API ID Path**: navigation.footer_courses[].url
   * - **Documentation**: https://prismic.io/docs/fields/text
   */
  url: prismic.KeyTextField;
}
...
/**
 * Item in *Navigation → Footer — Site*
 */
export interface NavigationDocumentDataFooterSiteItem {
  /**
   * Label field in *Navigation → Footer — Site*
   *
   * - **Field Type**: Text
   * - **Placeholder**: How it Works
   * - **API ID Path**: navigation.footer_site[].label
   * - **Documentation**: https://prismic.io/docs/fields/text
   */
  label: prismic.KeyTextField;

  /**
   * URL field in *Navigation → Footer — Site*
   *
   * - **Field Type**: Text
   * - **Placeholder**: /courses
   * - **API ID Path**: navigation.footer_site[].url
   * - **Documentation**: https://prismic.io/docs/fields/text
   */
  url: prismic.KeyTextField;
}
...
/**
 * Item in *Navigation → Footer — Company*
 */
export interface NavigationDocumentDataFooterCompanyItem {
  /**
   * Label field in *Navigation → Footer — Company*
   *
   * - **Field Type**: Text
   * - **Placeholder**: About
   * - **API ID Path**: navigation.footer_company[].label
   * - **Documentation**: https://prismic.io/docs/fields/text
   */
  label: prismic.KeyTextField;

  /**
   * URL field in *Navigation → Footer — Company*
   *
   * - **Field Type**: Text
   * - **Placeholder**: /about
   * - **API ID Path**: navigation.footer_company[].url
   * - **Documentation**: https://prismic.io/docs/fields/text
   */
  url: prismic.KeyTextField;
}
...
interface NavigationDocumentData {
  ...
  >; /**
   * Footer — AP Courses field in *Navigation*
   *
   * - **Field Type**: Group
   * - **Placeholder**: *None*
   * - **API ID Path**: navigation.footer_courses[]
   * - **Tab**: Footer
   * - **Documentation**: https://prismic.io/docs/fields/repeatable-group
   */
  footer_courses: prismic.GroupField<
    Simplify<NavigationDocumentDataFooterCoursesItem>
  >;

  /**
   * Footer — Site field in *Navigation*
   *
   * - **Field Type**: Group
   * - **Placeholder**: *None*
   * - **API ID Path**: navigation.footer_site[]
   * - **Tab**: Footer
   * - **Documentation**: https://prismic.io/docs/fields/repeatable-group
   */
  footer_site: prismic.GroupField<
    Simplify<NavigationDocumentDataFooterSiteItem>
  >;

  /**
   * Footer — Company field in *Navigation*
   *
   * - **Field Type**: Group
   * - **Placeholder**: *None*
   * - **API ID Path**: navigation.footer_company[]
   * - **Tab**: Footer
   * - **Documentation**: https://prismic.io/docs/fields/repeatable-group
   */
  footer_company: prismic.GroupField<
    Simplify<NavigationDocumentDataFooterCompanyItem>
  >;

  /**
   * Footer Tagline field in *Navigation*
   *
   * - **Field Type**: Text
   * - **Placeholder**: AP practice questions, unit quizzes, and exam prep designed to help students build confidence.
   * - **API ID Path**: navigation.footer_tagline
   * - **Tab**: Footer
   * - **Documentation**: https://prismic.io/docs/fields/text
   */
  ...
  /**
   * Footer Disclaimer field in *Navigation*
   *
   * - **Field Type**: Text
   * - **Placeholder**: AP® is a trademark of the College Board, which is not affiliated with APScore5.
   * - **API ID Path**: navigation.footer_disclaimer
   * - **Tab**: Footer
   * - **Documentation**: https://prismic.io/docs/fields/text
   */
  footer_disclaimer: prismic.KeyTextField;
}
...
declare module "@prismicio/client" {
  ...
  namespace Content {
    export type {
      ...
      HomepageDocumentDataTrustItemsItem,
      HomepageDocumentDataStatsItem,
      HomepageDocumentDataCtaPointsItem,
      NavigationDocument,
      NavigationDocumentData,
      NavigationDocumentDataNavLinksItem,
      NavigationDocumentDataFooterCoursesItem,
      NavigationDocumentDataFooterSiteItem,
      NavigationDocumentDataFooterCompanyItem,
      QuizQuestionDocument,
